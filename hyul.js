...
recognition.onresult=function(lelelelelee){
console.log(lelelelelee);
var wakanda=lelelelelee.results[0][0].transcript;
document.getElementById("textbox").innerHTML=wakanda;
if(wakanda=="dog"){
console.log("dog");
speak();
}
